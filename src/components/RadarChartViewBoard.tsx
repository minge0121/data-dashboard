...
import { radarChartData } from "@/data/mock";
    ...
    series: [
      {
        ...
        data: [
          {
            value: [92, 85, 78, 88, 82, 90], // 与 indicator 顺序对应的数值
            name: "当前评分",
            areaStyle: {
              color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [ // 垂直渐变填充
          ...
          {
            value: [85, 80, 72, 82, 78, 85],
            name: "上月评分",
            lineStyle: {
              color: "rgba(0,230,118,0.4)",  // 半透明绿色
              width: 1,
              type: "dashed",  // 虚线，表示对比参考
            },
            itemStyle: { color: "#cabb10ff" }, 
            areaStyle: { color: "rgba(192, 227, 20, 0.05)" },
          },
        ],
      },
    ],
